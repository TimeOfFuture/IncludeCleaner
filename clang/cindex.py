...
class SourceRange(Structure):
    ...
    # FIXME: Eliminate this and make normal constructor? Requires hiding ctypes object.
    @staticmethod
...
class Config:
    ...
    def set_library_path(path):
        ...
        if Config.loaded:
            raise Exception("library path must be set before using any other functionalities in libclang.")
    ...
    def set_library_file(filename):
        ...
        if Config.loaded:
            raise Exception("library file must be set before using any other functionalities in libclang.")
